...
function prime_portfolio_resume_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'prime_portfolio_responsive_media_section',
        array(
            'title' => esc_html__( 'Responsive Media Settings', 'prime-portfolio-resume' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_setting( 
        'prime_portfolio_resume_resp_scroll_top', 
        array(
            'default' => 1,
            'sanitize_callback' => 'prime_portfolio_resume_sanitize_checkbox',
        ) 
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'     => 'prime_portfolio_responsive_media_section',
            'type'        => 'checkbox',
        )
    );
        ...
        /** Scroll to top Responsive control */
    $wp_customize->add_setting( 
        'prime_portfolio_resume_resp_loader', 
        array(
            'default' => 0,
            'sanitize_callback' => 'prime_portfolio_resume_sanitize_checkbox',
        ) 
    ...
    $wp_customize->add_control(
        'prime_portfolio_resume_resp_loader',
        array(
            'label'       => __( 'Show Preloader', 'prime-portfolio-resume' ),
            'section'     => 'prime_portfolio_responsive_media_section',
            'type'        => 'checkbox',
        )
    );
    ...
    $wp_customize->add_setting('prime_portfolio_resume_archive_pagination_alignment',array(
        'default' => 'left-align',
        'sanitize_callback' => 'prime_portfolio_resume_sanitize_pagination_alignment'
    ));
    $wp_customize->add_control('prime_portfolio_resume_archive_pagination_alignment',array(
        'type' => 'select',
        'label' => __('Pagination Alignment','prime-portfolio-resume'),
        'section' => 'prime_portfolio_resume_post_layout_section',
        'choices' => array(
   ...
   $wp_customize->add_setting('prime_portfolio_resume_single_post_align',array(
    ...
    $wp_customize->add_setting('prime_portfolio_resume_scroll_top_alignment',array(
        'default' => 'right-align',
        'sanitize_callback' => 'prime_portfolio_resume_sanitize_scroll_top_alignment'
    ));
    $wp_customize->add_control('prime_portfolio_resume_scroll_top_alignment',array(
        'type' => 'select',
        'label' => __('Scroll Top Alignment','prime-portfolio-resume'),
        'section' => 'prime_portfolio_resume_general_settings',
        'choices' => array(
            'right-align' => __('Right Alignment','prime-portfolio-resume'),
            'center-align' => __('Center Alignment','prime-portfolio-resume'),
